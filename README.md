...
> For simulation with ROS/Gazebo, please visit the companion repository: [chelon_asv_sim](https://github.com/YOUR-ORG/chelon_asv_sim).
...
### Running the stack
```bash
roslaunch chelon_bringup bringup_real.launch
```

### Configuration
- Parameters can be changed in `ros/chelon_bringup/config/params.yaml`.  
