...
class GpsImuOdometry:
    ...
    def __init__(self, sim=False):
        ...
        lat0 = rospy.get_param('map/lat0', 39.3665100) #38.9344030) #39.3665100) #39.330791) #)#39.30367267)
        lon0 = rospy.get_param('map/lon0', 16.2264100)#16.2082441) #16.226410) #16.250741) #)#16.25211817)
        ...
        self.state_msg.model_name = 'asv3'
