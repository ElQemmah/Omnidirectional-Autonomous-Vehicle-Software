...
class ThrustersManager2:
    ...
    def phase_correction(self):
        ''' Software compensation of rotation based on hardware links '''
        self.T_1234[0] = -1*self.T_1234[0]
        #self.T_1234[1] = self.T_1234[1]
        #self.T_1234[2] = -1*self.T_1234[2]
        #self.T_1234[3] = self.T_1234[3]
