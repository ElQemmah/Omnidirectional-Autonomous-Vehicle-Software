...
class ThrustersManager2:
    ...
    def loop(self):
        ...
        while not rospy.is_shutdown():
            msg_str = ''
            msg_str_pub = ''
            #self.compute_thrust_allocation() 
    ...
    def compute_thrust_allocation(self):
        #self.T_1234[0] = 0.0
        #self.T_1234[1] = 0.0
        #self.T_1234[2] = 0.0
        #self.T_1234[3] = 0.0
        T_1234 = np.dot(self.sigma_pinv, self.T_uvr)
        self.T_1234[0] = T_1234[0]
        self.T_1234[1] = T_1234[1]
        self.T_1234[2] = T_1234[2]
        self.T_1234[3] = T_1234[3]
        """
        for j in range(len(self.T_uvr)):
            for i in range(len(self.T_1234)):
                self.T_1234[i] += self.Sigma[i][j]*self.T_uvr[j]
        """
